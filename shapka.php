...
<link rel="stylesheet" href="Главная.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-sticky u-sticky-849b u-header" id="sec-ed6c"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link">Галерея</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link">Новости</a>
        ...
        <a  class="u-border-none u-btn u-btn-round u-button-style u-palette-1-light-2 u-radius-15 u-btn-1" ><button onclick="document.getElementById('id01').style.display='block'" style="width:0 auto;">Войти</button></a>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/auth.php">
    <div class="imgcontainer">
      ...
      <img src="/images/Виджет ВК - 2.png" alt="Avatar" class="avatar">
    </div>
